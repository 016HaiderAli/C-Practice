...
int main()
{
    ...
    // cout<<"There are three categories of tickets: /n Free: Ages 0-3 get free tickets /n Discounted: Ages 4-6 get discounted tickets. /n Normal: Ages 7+ get a normal ticket."<<endl;
